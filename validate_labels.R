...
validate_labels <- function(daily_predicted_labeled_data,confusion_matrix_title = "Confusion Matrix",
  ...
  plot_confusion_matrix(predicted_flags, valid_flags, plot_title = confusion_matrix_title,
...
{
  db_data <- fread(paste0(getwd(),"/Anomalous_Emissions_Results/Labeled_Emissions_DBSCAN_Test_Three_Hundredths_Border_Anoms.csv"))
